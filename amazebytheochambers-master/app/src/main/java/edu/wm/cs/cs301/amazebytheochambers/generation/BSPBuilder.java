...
import edu.wm.cs.cs301.amazebytheochambers.gui.Constants;
...
public class BSPBuilder {
	 ...
	 */
	private BSPNode genNodes(List<Wall> walls) throws Exception {
		// Recursion anchor:
	 ...
	 * @throws InterruptedException if its executing thread is interrupted
	 */
	private Wall findSplitter(List<Wall> walls) throws Exception {
		Wall result = null ;
	 ...
	 */
	private void updateProgressBar(int partiters) throws Exception {
	 ...
	 * @throws InterruptedException if executing thread is interrupted
	 */
	public BSPNode generateBSPNodes() throws Exception {
