...
import edu.wm.cs.cs301.amazebytheochambers.gui.MazePanel;
import edu.wm.cs.cs301.amazebytheochambers.gui.MazeFileWriter;
...
public class Wall {
     ...
     * @param cc
     */
    private void createColor(final int distance, final int cc) {
