...
import edu.wm.cs.cs301.amazebytheochambers.generation.BSPBranch;
import edu.wm.cs.cs301.amazebytheochambers.generation.BSPLeaf;
import edu.wm.cs.cs301.amazebytheochambers.generation.BSPNode;
import edu.wm.cs.cs301.amazebytheochambers.generation.Floorplan;
import edu.wm.cs.cs301.amazebytheochambers.generation.Wall;
...
public class FirstPersonView {
     ...
     * @param mp for drawing on the buffer image
     ...
     *
     */
    public void draw(MazePanel mp, int x, int y, int walkStep, int ang, float percentToExit) {
        this.mp = mp;
        if (null == this.mp) {
        ...
        mp.addBackground(percentToExit); // call add background from mazepanel
